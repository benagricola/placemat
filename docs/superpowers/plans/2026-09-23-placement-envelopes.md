...
The cleanup-pass plan (`2026-09-23-cleanup-pass.md`) follows this one and becomes 0.24.0; its envelope-aware legality comes for free, since it moves parts through `occ.legal` and `scan()`.
